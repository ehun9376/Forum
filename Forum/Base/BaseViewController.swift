...
open class BaseViewController: UIViewController {
    ...
    lazy var firstWindows = UIKit.UIApplication.shared.windows.first {
        didSet {
            firstWindows?.makeKeyAndVisible()
        }
    }
    ...
    public func showSingleAlert(title:String, message: String, confirmTitle: String = "確認", confirmAction: (()->())? = nil){
        DispatchQueue.main.async {
            let controller = UIAlertController(title: title, message: message, preferredStyle: .alert)
